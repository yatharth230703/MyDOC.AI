...
<body>
  ...
  if (window.ethereum) {
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top2">
        <a class="navbar-brand" href="#" style="padding:10px 5px"><img src="images/logo.PNG" height="50px" style="position:relative;left:10px;top:10px"></img>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a type="button" class="connect btn btn-info" href="/login.php" style="padding:11px 25px; border-radius:35px; background-color: #5da99c; border: #5da99c; box-shadow:0px 0px 1px 1px rgba(0, 0, 0, 0.25); position:relative; left:70px">LOGIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a type="button" href="#" class="btn btn-info" style="padding:11px 25px;border-radius:35px; background-color:white; position:relative;left:5px;z-index:-2;color:black; padding-left:50px;border:white;">SIGN UP</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </form>
        </div>
    </nav>
    <br><br>
    <div class="parallelogram"></div>
    <h1 style="color:white; position:relative; top:-80px;left:60px; font-family:Sen">Your healthcare partner for lifetime. </h1>
    <br>
    
    <br>
    <h3 style="color:white; position:relative; top:-80px;left:60px; font-family:Sen">How are you feeling today?</h3>
    <div style="display: flex;">


    <input type="text" placeholder="fever, infection, etc.." name="symptom1" style="color:black; position:relative; top:-75px;left:60px; font-family:Sen; border-radius:20px;display:inline-block;">   
    
    
    
    <a type="button" href="#" class="btn btn-info" style="padding:11px 25px;border-radius:20px; background-color:white; position:relative;left:5px;z-index:-2;color:black; padding-left:70px;border:white;display:inline-block;top:-75px;background-color:#dedede;"><img src="images/upload2.png" height="25px"></img></a></div>
    
    <h5 style="color:white; position:relative; top:-50px;left:60px; font-family:Sen"> We are an AI based platform where we help provide <br> the best prescriptions for you with all considerations <br> taken in place, for free!
    </h5>
    <br>
    <div>
    <a type="button" href="why-choose-us.php" class="btn btn-info" style="padding:11px 25px;border-radius:15px; position:relative;left:5px;z-index:1;color:white; border:white;display:inline-block;top:-35px;background-color:rgba(255, 255, 255, 0.25);box-shadow:0px 0px 1.5px 1.5px rgba(0, 0, 0, 0.25); left:60px; width:200px"> WHY CHOOSE US? </a>  &nbsp; &nbsp;&nbsp;&nbsp; <a type="button" href="signup.php" class="btn btn-info" style="padding:11px 25px;border-radius:15px;; position:relative;left:5px;z-index:1;color:white; border:white;display:inline-block;top:-35px;background-color:rgba(255, 255, 255, 0.25);box-shadow:0px 0px 1.5px 1.5px rgba(0, 0, 0, 0.25); left:60px; width:150px"> SIGN UP </a> </div>
