...
<body>
    ...
    <h1 style="color:white; font-family:Sen;text-align:center;">Health Plans we provide</h1>
    <br>
    <div class="card mx-auto" style="width: 80%;float:center;">
  <div class="card-body">
    <h3 class="card-title">Free Plan</h3>
    <p class="card-text">You are going to get unlimited prescriptions. <br> Web2 based, data to be centrally stored in our database. </p>
    <a href="#" class="btn btn-primary" style="padding:13px 37px; font-size:1.5rem;border-radius:35px; background-color: #5da99c; border: #5da99c; box-shadow:0px 0px 1px 1px rgba(0, 0, 0, 0.25);">Free</a>
  </div>
</div>
...
<div class="card mx-auto" style="width: 80%;float:center;">
  <div class="card-body">
    <h3 class="card-title">The Family Doctor Plan (Paid)</h3>
    <p class="card-text">You are going to get unlimited prescriptions. <br> Web3 based, decentralised applications (DAPPs) </p>
    <div class="row">
    <div class="col sm-4">
    <a href="#" class="btn btn-primary" style="padding:13px 37px; font-size:1rem;border-radius:35px; background-color: #5da99c; border: #5da99c; box-shadow:0px 0px 1px 1px rgba(0, 0, 0, 0.25);">1 Member <br> <h4 style="font-size:1.3rem">2 USDT</h4></a>
    </div>
    <div class="col sm-4">
    <a href="#" class="btn btn-primary" style="padding:13px 37px; font-size:1rem;border-radius:35px; background-color: #5da99c; border: #5da99c; box-shadow:0px 0px 1px 1px rgba(0, 0, 0, 0.25);">2 Member <br> <h4 style="font-size:1.3rem">3 USDT</h4></a>
    </div>
    <div class="col sm-4">
    <a href="#" class="btn btn-primary" style="padding:13px 37px; font-size:1rem;border-radius:35px; background-color: #5da99c; border: #5da99c; box-shadow:0px 0px 1px 1px rgba(0, 0, 0, 0.25);">4 Member <br> <h4 style="font-size:1.3rem">5 USDT</h4></a>
    </div>
    </div>
  </div>
</div>
