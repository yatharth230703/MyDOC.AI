...
<body>
    ...
    <h1 style="color:white; font-family:Sen;text-align:center;"><u>About Us</u></h1>
    <br>
    <h3 style="color:white; font-family:Sen;text-align:center;">We hope to build a platform, which enables us to spread the reach of modern healthcare systems to each and every citizen, with the help of Artificial Intelligence and Decentralized Networks.</h3> <br> <p>
    <h3 style="color:white; font-family:Sen;text-align:center;">Our main aim is to provide a "Family Doctor" to each and every family out there, to even those who cannot afford regular checkups, and provide timely basic treatments.</h3> <br>
    <h3 style="color:white; font-family:Sen;text-align:center;">Our web app provides free and instant access to some smart machine learning models, which helps individuals get to basic first aid, but on the other hand we also offer "The Family Doctor Package" which involves long term data collection and deployment on web3, which provides a ton of key differentiators to our Web App / DApp</h3>
